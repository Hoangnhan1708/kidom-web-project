...
function CartItem({ item, onCheck }) {
    const { productId, imageUrl, name, price, quantity, checked } = item;
    const [__quantity, setQuantity] = useState(quantity);
    ...
    const handleCheck = (e) => {
        onCheck(productId, e.target.checked);
    };
    ...
    return (
        <div className={`row align-items-center ${cx('wrapper')}`}>
            ...
            <div className="col">
                <InputQuantity quantity={__quantity} setQuantity={setQuantity} className="col" />
            </div>
            <div className={`col ${cx('box')}`}>
...
// function CartItem({ productId, img, name, price, oldQuantity, onCheck }) {
...
//     return (
//         <div className={`row align-items-center ${cx('wrapper')}`}>
//             <input type="checkbox" checked={checked} className={`col ${cx('checkbox')}`} />
//             <div className={`col ${cx('box')}`}>
